...
/**
  ...
  /**
   * `prisma.periodoRegular`: Exposes CRUD operations for the **PeriodoRegular** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more PeriodoRegulars
    * const periodoRegulars = await prisma.periodoRegular.findMany()
    * ```
    */
  get periodoRegular(): Prisma.PeriodoRegularDelegate<ExtArgs, { omit: OmitOpts }>;
